...
<head>
    ...
    <title>RecipeFlo - Créer Menu</title>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-md p-6 sticky top-8">
                    ...
                    @php
                        $action = '/api/menus';
                    <form id="menu-form" action="/api/menus" method="POST" onsubmit="return submitMenuForm(event);">
                        @csrf
                        ...
                        <div class="border-t pt-4 mt-6">
                            <button type="submit" class="w-full bg-orange-500 text-white py-3 px-4 rounded-lg hover:bg-orange-600 transition-colors">
                                <i class="fas fa-save mr-2"></i>Enregistrer le menu
                            </button>
                        </div>
                    </form>
